...
const worldcupMarketsPath = resolve(webRoot, 'lib/worldcup-markets.ts');
...
const featureFlagsDefault = loadTsModule(featureFlagsPath, true);
assert.equal(featureFlagsDefault.WORLDCUP_ENABLED, true);
